...
conference={New perspectives on arts and sciences},
year={2011}
}
...
\begin{imagecredits}
  \item[Fig. \ref{fig:sample-image}] \copyright\ Archives of the Mathematisches Forschungsinstitut Oberwolfach, \url{http://www.mfo.de/test_for/long/url.html}, 2004
  \item[Fig. \ref{fig:euclid}] \copyright\ "Euclid". Licensed under Public domain via Wikimedia Commons, \url{http://commons.wikimedia.org/wiki/File:Euclid.jpg#mediaviewer/File:Euclid.jpg}, accessed 05-August-2014
\end{imagecredits}

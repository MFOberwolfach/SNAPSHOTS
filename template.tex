...
%%% Please provide your references here or as a .bib file. If you use a .bib file, please do not forget to *submit* it with your .tex file when uploading it on www.imaginary.org.
...
\section{A heading}
Your actual snapshot. As usual, you can give references such as \cite{knuth1977fast,knuth1986texbook} via the \verb+\cite+ command.\\

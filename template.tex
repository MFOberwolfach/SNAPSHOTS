...
%%% Please select 'ngerman' if you want to submit your snapshot in German. If you do choose 'ngerman', please run your LaTeX compiler *twice*.
...
\begin{abstract}
This is your abstract. It should give a brief overview of your snapshot. If possible, please do not use formulas in your abstract. Please do not use more than 300 symbols. You will be asked to copy your abstract into the upload form on \url{www.imaginary.org}. 
\end{abstract}

...
%%% To provide your references you may
%%%   - either replace the following references by your own ones and leave the \bibliography command at the end of this file unchanged
%%%   - or provide your own .bib file, delete everything until \end{filecontents} and make the \bibliography command at the end of this file point to your .bib file
%%%   - or use the \bibitem command, delete everything until \end{filecontents} and delete the \bibliography command at the end of this file.
...
%%% According to your above choice on how to handle your references you will
%%%   - either want to leave the following command unchanged
%%%   - or make it point to your .bib file like \bibliography{yourbibfile}
%%%   - or delete the command completely:
\bibliography{\jobname}
%%% If you provide your own .bib file, please do not forget to *submit* it together with your .tex file and your graphics files, if applicable.

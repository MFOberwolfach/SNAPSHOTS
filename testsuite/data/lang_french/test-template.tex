...
%\usepackage[noabbrev,capitalise,nameinlink,ngerman]{cleveref}
%\usepackage[noabbrev,capitalise,nameinlink,spanish]{cleveref}
\usepackage[noabbrev,capitalise,nameinlink,french]{cleveref}
...
\begin{verbatim}
LaTeX-Result: 0 Error(s), 8 Warning(s), 0 Bad Box(es), 5 Pages(s)
...
\begin{verbatim}
Package isodate Warning: Language french unknown to isodate.
\end{verbatim}

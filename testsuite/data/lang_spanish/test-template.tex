...
\begin{verbatim}
LaTeX-Result: 0 Error(s), 10 Warning(s), 2 Bad Box(es), 6 Pages(s)
...
In addition, the spanish version will yield two ``isodate'' warnings
\begin{verbatim}
Package isodate Warning: Language spanish unknown to isodate.
\end{verbatim}
but the output look fine nonetheless.
